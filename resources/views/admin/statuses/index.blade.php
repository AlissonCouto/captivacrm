...
@section('content')
    ...
    <div class="header-table">
        ...
        <div class="meta-infos">
            ...
            <h2 class="title">Status <span id="entity-quantity">({{ $total }})</span></h2>

            <div class="filter">

                <form class="search-container" action="{{route('statuses.search')}}" method="post" id="search-entity">
                ...
                <a href="{{route('statuses.create')}}" class="new-button">Novo</i></a>
